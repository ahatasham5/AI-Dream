...
- `debugpy` দিয়ে নিরাপদে remote debugging করতে পারবে
- `tracemalloc`/`objgraph` দিয়ে memory snapshot তুলনা করে memory leak শনাক্ত করতে পারবে
- `py-spy`/`cProfile` দিয়ে CPU profiling ও flame graph দিয়ে ধীরগতির root cause খুঁজে বের করতে পারবে

পরবর্তী মডিউল: **[Module 35 — Advanced Topics](../module-35-advanced-topics/README.md)**

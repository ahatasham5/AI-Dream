...
Module 31-এ আমরা শিখেছি API-এর পারফরম্যান্স কীভাবে মাপতে ও উন্নত করতে হয়, আর দেখেছি এই পুরো প্রক্রিয়ায় logging কতটা গুরুত্বপূর্ণ ভূমিকা রাখে। এই মডিউলে আমরা সেই logging-কে একটা প্রফেশনাল, প্রোডাকশন-রেডি সিস্টেমে পরিণত করবো — Python-এর `logging` ও `structlog` দিয়ে শুরু করে, structured logging-এর নিয়ম মেনে, প্রতিটা request/response আর error স্বয়ংক্রিয়ভাবে ধরে, আর লগ ফাইল নিয়ন্ত্রিতভাবে সংরক্ষণ করে।

## Lessons

| # | ফাইল | টপিক |
|---|------|------|
| 1 | [01-implementing-logging-with-python-logging-and-structlog.md](01-implementing-logging-with-python-logging-and-structlog.md) | Python `logging` ও `structlog` দিয়ে logging শুরু করা |
...
- Python-এর `logging` মডিউল ও `structlog` লাইব্রেরি দিয়ে প্রোডাকশন-গ্রেড logger সেটআপ করতে পারবে
...
পরবর্তী মডিউল: **[Module 33 — Monitoring & Alerting](../module-33-monitoring-and-alerting/README.md)**

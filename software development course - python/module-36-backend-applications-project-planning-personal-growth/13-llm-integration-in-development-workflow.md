...
```mermaid
sequenceDiagram
    participant Script as আমাদের Python Script
...
def explain_error(error_message: str, stack_trace: str) -> str:
    response = client.messages.create(
        model="claude-sonnet-4-5",
        max_tokens=300,
        messages=[{
            "role": "user",
            "content": f"এই error-টা বাংলায় সহজ করে ব্যাখ্যা করো, সম্ভাব্য কারণসহ:\n{error_message}\n{stack_trace}",
        }],
    )

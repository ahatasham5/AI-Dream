...
```python
def get_streak(completions: list[date]) -> int:
...
AI-কে বলা যায় "এই function-এর জন্য docstring লেখো", আর ফলাফল হবে:
...
def get_streak(completions: list[date]) -> int:
    ...
    Args:
        completions: সেই habit-এর সব completion তারিখ।

    Returns:
        আজ থেকে পিছিয়ে গিয়ে পরপর সম্পন্ন দিনের সংখ্যা।
    """
```

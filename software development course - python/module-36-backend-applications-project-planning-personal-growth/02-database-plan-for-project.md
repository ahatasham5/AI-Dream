...
SQLAlchemy-এর মতো ORM দিয়ে এই স্কিমা কোডে এভাবে প্রকাশ করা যায়:
...
ফরেন কী (`user_id`) দিয়ে আমরা নিশ্চিত করছি প্রতিটা Habit ঠিক একজন User-এর সাথে যুক্ত থাকে — যেটা আগের লেসনের classDiagram-এ `User "1" --> "many" Habit` সম্পর্কটার হুবহু ডেটাবেজ প্রতিফলন।

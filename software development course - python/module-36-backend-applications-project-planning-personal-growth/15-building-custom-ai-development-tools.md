...
def generate_commit_message() -> None:
    ...
    if not diff:
        print("কোনো staged পরিবর্তন নেই।")
        return
    ...
    response = client.messages.create(
        ...
        messages=[{
            "role": "user",
            "content": f"নিচের git diff-এর জন্য একটা সংক্ষিপ্ত, conventional commit style message লেখো (feat:/fix:/refactor: দিয়ে শুরু):\n\n{diff}",
        }],
    )
    print("প্রস্তাবিত commit message:\n", response.content[0].text)

...
```python
class Goal:
    def __init__(self, id: str, title: str, deadline: date):
        self.id = id
        self.title = title
    ...
    def update_progress(self, value: int) -> None:
        ...
        self.progress = min(100, max(0, self.progress + value))
```

লক্ষ্য করো, AI `min`/`max` দিয়ে bounds check করার সাজেশন দিতে পারে কারণ এই প্যাটার্নটা লক্ষ লক্ষ কোডবেসে দেখা গেছে "progress bar" জাতীয় জিনিসের জন্য। কিন্তু AI জানে না যে আমাদের ব্যবসায়িক নিয়ম কী — progress কি নেগেটিভ হতে পারবে? এটা ডেভেলপারের সিদ্ধান্ত, AI-এর সাজেশন শুধু একটা শুরুর বিন্দু।

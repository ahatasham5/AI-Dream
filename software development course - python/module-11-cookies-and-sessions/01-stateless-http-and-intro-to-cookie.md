...
Module 4-এ আমরা দেখেছিলাম প্রতিটা HTTP request-response একটা সম্পূর্ণ স্বাধীন লেনদেন — request যায়, response আসে, ব্যস, সম্পর্ক শেষ। FastAPI-র কোনো route function কখনো মনে রাখে না আগের কোন request তাকে হিট করেছিলো, যদি না আমরা নিজে থেকে কিছু ব্যবস্থা করি। প্রতিটা request সার্ভারের কাছে সম্পূর্ণ নতুন একজন আগন্তুক।
...
এই ব্যাপারটা ভাষা বা ফ্রেমওয়ার্ক-নিরপেক্ষ একটা HTTP প্রোটোকল-লেভেল ধারণা — Node.js/Express-এ যেমন `Set-Cookie`/`Cookie` header দুটোই একই নিয়মে কাজ করে, ঠিক তেমনই Python/FastAPI-তেও। ফ্রেমওয়ার্ক যেটাই হোক, ব্রাউজার-সার্ভারের মাঝে আসলে এই দুইটা header-ই যাতায়াত করে; ফ্রেমওয়ার্ক শুধু এই header তৈরি ও পড়ার কাজটা সহজ করে দেয়।
...
পরের লেসনে আমরা সত্যিকারের FastAPI কোড লিখে দেখবো, কীভাবে সার্ভার থেকে একটা Cookie বানানো যায় আর ব্রাউজারে সেভ করা যায়।

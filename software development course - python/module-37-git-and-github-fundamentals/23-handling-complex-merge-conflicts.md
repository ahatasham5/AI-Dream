...
# both modified: models/task.py
# both modified: routes/tasks.py
# added by us: utils/validator.py
```
...
```bash
git diff models/task.py       # conflict মার্কারসহ দেখা
# ম্যানুয়ালি ঠিক করার পর
git add models/task.py
```

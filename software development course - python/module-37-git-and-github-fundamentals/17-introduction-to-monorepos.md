...
│   ├── shared-utils/
│   └── frontend/
├── pyproject.toml        # workspace configuration (uv/poetry)
└── Makefile               # (ঐচ্ছিক) build orchestration স্ক্রিপ্ট
```

`shared-utils`-এর কোনো পরিবর্তন এখন একই commit-এ `task-api`-র সাথে সাথে দেখা যায় আর টেস্ট করা যায় — Module ৩৭.১৬-এর মতো আলাদা করে submodule আপডেট করার প্রয়োজন নেই। Python-এ `uv` workspaces বা Poetry-র মতো টুল ব্যবহার করে একটা কমান্ডে সব প্যাকেজ ইনস্টল/টেস্ট করা যায়:

```bash
uv sync                       # সব প্যাকেজের dependency একসাথে ইনস্টল
uv run pytest packages/       # সব প্যাকেজে টেস্ট চালানো
```

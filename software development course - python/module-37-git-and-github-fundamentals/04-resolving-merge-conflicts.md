...
আগের লেসনের শেষে আমরা একটা প্রশ্ন রেখেছিলাম — দুইজন ডেভেলপার একই লাইনে ভিন্ন পরিবর্তন করলে কী হয়? ধরো TaskFlow API-তে দুইজন ডেভেলপার, রিমা আর করিম, একই সময়ে `task.py` ফাইলের `status` ফিল্ডের ডিফল্ট মান বদলাতে গিয়েছে — রিমা `'pending'` করেছে, করিম `'todo'` করেছে। যখন করিম রিমার branch merge করতে যায়, Git থেমে যায় আর বলে "আমি বুঝতে পারছি না কোনটা রাখবো, তুমি সিদ্ধান্ত নাও।"
...
```python
status: str = "pending"  # টিমে আলোচনা করে ঠিক করা হলো
```

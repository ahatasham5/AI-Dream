...
```mermaid
flowchart TD
    Browser["ব্রাউজার (Client)"] -->|Port 3000| App["Application Server <br/> (তোমার Python/FastAPI কোড, Uvicorn দিয়ে চলে)"]
...
|---|---|---|
| Python/FastAPI Application Server (Uvicorn) | 8000 (বা 3000, 5000) | তোমার নিজের লেখা বিজনেস লজিক |

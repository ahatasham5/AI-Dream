...
এখানে একটা খুব গুরুত্বপূর্ণ পার্থক্য বুঝে নেয়া দরকার — **Hashing এনক্রিপশনের মতো নয়**। Python-এর built-in `hashlib` মডিউল দিয়েও ঠিক এই কাজটা করা যায় (এনক্রিপশন আর হ্যাশিং দুটোই), কিন্তু এই দুইটা সম্পূর্ণ ভিন্ন উদ্দেশ্যে কাজ করে।
...
এখন আমরা তত্ত্বগতভাবে জানি Hashing কী। পরের লেসনে আমরা Python-এর `passlib` লাইব্রেরি দিয়ে বাস্তবে একটা username আর password হ্যাশ করে দেখবো, হাতে-কলমে।

...
**একটা প্রোডাকশন নুয়ান্স** — যদিও JWT নিজেই ভাষা-নিরপেক্ষ (Node, Python, Go — যেকোনো ব্যাকএন্ড একই টোকেন পড়তে-লিখতে পারে), আমাদের কোর্সে এখন থেকে আমরা Python + FastAPI স্ট্যাক ব্যবহার করবো। যেখানে Node.js-এ এই কাজের জন্য `jsonwebtoken` আর `bcrypt` নামের npm প্যাকেজ ব্যবহার হতো, Python জগতে সমতুল্য কাজ করে `python-jose` বা `pyjwt` (JWT এনকোড/ডিকোড-এর জন্য) আর `passlib` (পাসওয়ার্ড হ্যাশিং-এর জন্য)। ধারণাগুলো হুবহু একই — Header-Payload-Signature গঠন, HMAC দিয়ে স্বাক্ষর যাচাই — শুধু সিনট্যাক্স আর প্যাকেজের নাম বদলাবে।

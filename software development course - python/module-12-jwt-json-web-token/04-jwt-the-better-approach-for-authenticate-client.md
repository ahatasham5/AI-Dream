...
তত্ত্ব অনেক হলো — এবার আসল কোড লেখার পালা। পরের লেসনে আমরা `pyjwt` প্যাকেজ আর FastAPI-এর `OAuth2PasswordBearer` ব্যবহার করে বাস্তবে JWT তৈরি এবং যাচাই করবো, একটা সম্পূর্ণ FastAPI রুটে।

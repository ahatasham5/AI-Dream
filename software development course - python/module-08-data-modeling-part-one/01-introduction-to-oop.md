...
Python-এ class লেখার সিনট্যাক্সটা দেখা যাক:

```python
class Car:
    def __init__(self, brand, color):
        # __init__ হলো একটা বিশেষ মেথড, যেটা object তৈরির সময় স্বয়ংক্রিয়ভাবে চলে
        self.brand = brand
        self.color = color
        self.speed = 0  # শুরুতে গতি শূন্য

    def accelerate(self, amount):
        # এটা একটা method — object-এর নিজস্ব আচরণ
        self.speed += amount
        print(f"{self.brand} এখন {self.speed} কিমি/ঘণ্টা গতিতে চলছে।")

    def brake(self):
        self.speed = 0
        print(f"{self.brand} থেমে গেছে।")


# class থেকে দুইটা আলাদা object (instance) তৈরি করা হলো
car1 = Car("Toyota", "সাদা")
car2 = Car("Honda", "কালো")
...
এখানে `self` শব্দটা লক্ষ্য করো — এটা বোঝায় "এই নির্দিষ্ট instance-টার নিজের ডেটা"। JavaScript-এ যেটাকে `this` বলা হতো, Python-এ ঠিক সেই জায়গাটাই নেয় `self` — পার্থক্য হলো Python-এ এটা স্বয়ংক্রিয়ভাবে আসে না, বরং প্রতিটা method-এর প্রথম প্যারামিটার হিসেবে স্পষ্টভাবে লিখে দিতে হয়। যখন `car1.accelerate(40)` কল করা হয়, তখন `self` মানে `car1`, আর যখন `car2.accelerate(60)` কল করা হয়, তখন `self` মানে `car2`। এই জন্যই দুইটা গাড়ি একে অপরের গতি নষ্ট না করে স্বাধীনভাবে চলতে পারে — প্রতিটা instance তার নিজের ডেটা আলাদাভাবে সংরক্ষণ করে।

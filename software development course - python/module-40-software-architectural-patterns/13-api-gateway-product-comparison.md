...
Resources:
  ...
  CreateTaskFunction:
    ...
    Properties:
      Handler: create_task.handler  # Python + Mangum (৪০.৩-এ দেখা) হলে FastAPI app-কেই handler বানানো যায়
      Runtime: python3.12
      Events:
        CreateTask:
          Type: Api

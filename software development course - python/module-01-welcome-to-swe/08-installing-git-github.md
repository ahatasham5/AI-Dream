...
ধরো তুমি একটা ফাইলে কাজ করছো, নাম `main.py`। কাজ করতে করতে হঠাৎ মনে হলো, "এই পরিবর্তনটা ভুল হয়ে গেলো, আগের ভার্সনে ফিরে যেতে চাই।"
...
main_v2.py
main_final.py
main_final_ACTUAL.py
main_final_ACTUAL_fixed.py
```
...
1. Runtime কী, এবং Python interpreter কেন দরকার?
2. `python` কমান্ড আর `pip` কমান্ডের মধ্যে পার্থক্য কী?

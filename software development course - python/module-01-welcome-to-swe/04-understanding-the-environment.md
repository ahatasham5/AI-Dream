...
flowchart TD
    ...
    OS --> Runtime[Runtime: Python Interpreter]
    Runtime --> PM[Package Manager: pip]
...
একটা প্রোগ্রামিং ভাষার কোড (যেমন Python) সরাসরি CPU বুঝতে পারে না। দরকার হয় একটা "অনুবাদক" যেটা কোডটাকে CPU-চালানোর মতো নির্দেশে রূপান্তর করে। এই অনুবাদক-প্রোগ্রামটাকে বলে **Runtime**।

**Python interpreter** (CPython, সবচেয়ে প্রচলিত) হলো Python-এর নিজস্ব runtime — এটা তোমার লেখা `.py` ফাইলকে সরাসরি তোমার কম্পিউটারে (server হিসেবেও) চালানোর ক্ষমতা দেয়। JavaScript-এর মতো ভাষাকে ব্রাউজারের বাইরে চালানোর জন্য আলাদা করে Node.js-এর মতো কিছু আনতে হয়েছিল, কিন্তু Python শুরু থেকেই একটা সাধারণ-উদ্দেশ্য ভাষা — এর runtime সবসময়ই কম্পিউটারে সরাসরি স্ক্রিপ্ট/সার্ভার চালানোর জন্য বানানো, ব্রাউজার-নির্ভরতা ছাড়াই।

> **তুলনার জন্য:** JavaScript শুরুতে *শুধু* ব্রাউজারে চলতো, ২০০৯ সালে Node.js আসার পরে সেটা দিয়ে server-ও বানানো সম্ভব হলো। Python-এর ক্ষেত্রে এই সমস্যাটাই ছিল না — Python শুরু থেকেই ব্যাকএন্ড, স্ক্রিপ্টিং, ডেটা সায়েন্স সবকিছুর জন্য ব্যবহৃত হয়েছে।
...
- সার্ভার চালু করা (`uvicorn main:app --reload`)
- প্যাকেজ ইনস্টল করা (`pip install fastapi`)
...
**pip** (Pip Installs Packages) হলো সেই টুল যেটা দিয়ে এই "অন্য মানুষের লেখা কোড" PyPI (Python Package Index) থেকে ইনস্টল, আপডেট এবং ম্যানেজ করা হয়। এটা Python-এর সাথেই আসে, আলাদা করে ইনস্টল করতে হয় না।

## সম্পর্কটা একবার আবার দেখি

```
OS (Windows/Mac/Linux)
  └── Runtime (Python interpreter) ইনস্টল করা হয় OS-এর উপর
        └── Package Manager (pip) আসে Python-এর সাথেই

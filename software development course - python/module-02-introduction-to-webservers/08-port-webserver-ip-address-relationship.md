...
আগের লেসনে আমরা লিখেছিলাম `HTTPServer(("localhost", 3000), MyHandler)`। এই `3000` সংখ্যাটা আমরা তখন তেমন গুরুত্ব না দিয়ে ব্যবহার করেছিলাম, শুধু বলেছিলাম এটা একটা "পোর্ট নম্বর"। এবার এই সংখ্যাটার প্রকৃত ভূমিকা বুঝি, আর দেখি কীভাবে এটা IP address আর ওয়েব সার্ভারের সাথে মিলে কাজ করে।
...
```mermaid
flowchart TD
    IP["IP Address<br/>(কম্পিউটারের ঠিকানা)"] --> P1["Port 3000<br/>আমাদের Python সার্ভার"]
...
| 3000 | Node.js/Python ডেভেলপমেন্ট সার্ভারের জন্য খুবই জনপ্রিয় প্রথা (Python/FastAPI-এ প্রায়ই 8000 পোর্টও দেখা যায়) |

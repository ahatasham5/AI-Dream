...
Python অ্যাপের দিক থেকেও (Module 15-এ শেখা ডাটাবেস কানেকশন মনে আছে?) `ALTER TABLE` চালানো একদম সাধারণ query-র মতোই:

```python
conn.execute("ALTER TABLE posts ADD COLUMN slug VARCHAR(220)")
```

বাস্তব প্রজেক্টে অবশ্য এই ধরনের স্কিমা পরিবর্তন সরাসরি হাতে চালানোর বদলে **migration file** নামের ভার্সন-কন্ট্রোল-করা স্ক্রিপ্টে লেখা হয় (যেমন Module 24-এ Alembic migration নিয়ে দেখবে), যাতে টিমের সবাই একই ক্রমে একই পরিবর্তন প্রয়োগ করতে পারে, আর Git-এ (Module 37) এর ইতিহাস ট্র্যাক করা যায়।

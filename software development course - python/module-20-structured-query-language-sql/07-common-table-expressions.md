...
আগের লেসনে যে nested query লিখেছিলাম, সেটা একবার পড়ে বুঝা একটু কষ্টকর ছিল — ভেতরের কোয়েরি আগে খুঁজে বের করতে হয়, তারপর বাইরেরটা। **CTE (Common Table Expression)** এই একই কাজ করে, কিন্তু কোয়েরিটাকে ওপর থেকে নিচে, ধাপে ধাপে পড়ার মতো করে সাজায় — অনেকটা Module 5-এ শেখা `async/await`-এর মতো, যেটা নেস্টেড callback-এর জটিলতা সরিয়ে কোডকে একটার পর একটা ধাপ হিসেবে পড়ার সুযোগ দিয়েছিল।

...
একটা তুলনা যেটা মনে রাখলে সহজ হয় — পাইথনের লিস্ট কম্প্রিহেনশনে `if` কন্ডিশন বা `filter()`-এর সাথে INNER JOIN-এর একটা মিল আছে: এগুলো শুধু শর্ত পূরণ করা উপাদান রাখে, ঠিক যেমন INNER JOIN শুধু মিল থাকা সারি রাখে। কিন্তু LEFT JOIN-এর কোনো সরাসরি লিস্ট অপারেশন তুলনা নেই — এটা SQL-এর নিজস্ব একটা শক্তিশালী ক্ষমতা, যেটা সহজ লুপ দিয়ে অনুকরণ করা বেশ কষ্টকর।

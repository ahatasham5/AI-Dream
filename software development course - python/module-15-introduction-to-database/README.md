...
এই মডিউলে আমরা বুঝেছি কেন Module 12-এর "No Database" TODO Manager-এর ডেটা সার্ভার রিস্টার্ট হলেই হারিয়ে যেত, এবং সেই সমস্যার সমাধান হিসেবে নিজের কম্পিউটারে PostgreSQL ইনস্টল করে, Python/FastAPI অ্যাপের সাথে SQLAlchemy দিয়ে কানেক্ট করে, পুরো TODO Manager-কে একটা স্থায়ী ডেটাবেজ-চালিত fullstack application-এ রূপান্তর করেছি।
...
- SQLAlchemy (`create_engine`), `.env` ফাইল, আর connection pooling ব্যবহার করে FastAPI অ্যাপকে PostgreSQL-এর সাথে কানেক্ট করতে পারবে
...
পরবর্তী মডিউল: **[Module 16 — Database Schema And SQL Introduction](../module-16-database-schema-and-sql-introduction/README.md)**

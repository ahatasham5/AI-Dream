...
এখন পর্যন্ত আমরা যেভাবে ডাটাবেসের সাথে কথা বলেছি, তার ধরনটা এরকম — আমাদের Python/FastAPI অ্যাপ্লিকেশন (Module 4-5) একটা SQL স্ট্রিং তৈরি করে, সেটা নেটওয়ার্কের মধ্য দিয়ে ডাটাবেস সার্ভারে পাঠায়, ডাটাবেস সেটা চালায়, ফলাফল আবার নেটওয়ার্কের মধ্য দিয়ে ফেরত পাঠায়। এই পুরো প্রক্রিয়ায় যদি একটার বদলে পাঁচটা কুয়েরি একসাথে চালানোর দরকার হয় (যেমন একটা অর্ডার তৈরি করা, স্টক কমানো, লগ লেখা), তাহলে পাঁচবার নেটওয়ার্কে যাওয়া-আসা করতে হয়। এই সমস্যার একটা সমাধান হলো **Stored Procedure**।

একটা Stored Procedure হলো এমন একটা SQL কোডের ব্লক, যেটা ডাটাবেস সার্ভারের **ভেতরেই** সংরক্ষিত থাকে, একটা নাম দিয়ে, ঠিক যেমন Module 13-14-এ আমরা Python-এ একটা ফাংশন লিখে সেটাকে নাম দিয়ে বারবার কল করতাম। পার্থক্য হলো, এই "ফাংশন" থাকে ডাটাবেসের ভেতরে, অ্যাপ্লিকেশন কোডে না।

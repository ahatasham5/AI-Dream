...
Firebase Admin SDK দিয়ে Python থেকে Firestore ব্যবহার করা যায় এভাবে:
...
def create_order(customer_id: str, total: float) -> str:
...
def get_pending_orders_over_1000():
    docs = (

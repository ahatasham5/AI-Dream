...
```python
# Python থেকে SSL/TLS সহ ডাটাবেস কানেকশন — Encryption in Transit
import psycopg2
...
conn = psycopg2.connect(
    ...
    sslmode="verify-full",  # নিশ্চিত করা যে সংযোগটা যাচাইকৃত সার্টিফিকেট দিয়ে এনক্রিপ্টেড
)
```
...
SECRET_KEY = bytes.fromhex(os.environ["ENCRYPTION_KEY"])  # ৩২ বাইটের গোপন key
...
encrypted_nid = encrypt("1990123456789")
await db.execute("INSERT INTO citizens (nid) VALUES (:nid)", {"nid": encrypted_nid})
```

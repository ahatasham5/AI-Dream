...
Firebase Realtime Database বোঝার আগে, চলো একটা ফারাক স্পষ্ট করি যা আমাদের এত দিনের শেখা সবকিছুর বিপরীত। Module 16-20 জুড়ে আমরা ডেটাকে দেখেছি টেবিল, রো, কলাম হিসেবে — সুনির্দিষ্ট স্কিমা (schema) মেনে, যেখানে প্রতিটা রো-র গঠন একই রকম হতে হয়। Firebase Realtime Database সম্পূর্ণ ভিন্নভাবে চিন্তা করে — এটা পুরো ডাটাবেসকে দেখে **একটামাত্র বিশাল JSON ট্রি** হিসেবে। এটা অনেকটা একটা ফোল্ডার সিস্টেমের মতো — প্রতিটা "ফোল্ডার" (key) এর ভেতরে আরও ফোল্ডার বা আসল ডেটা (value) থাকতে পারে, ঠিক যেভাবে পাইথনের একটা dictionary-র ভেতরে আরেকটা dictionary নেস্টেড থাকতে পারে (Module 4-5-এ আমরা যা দেখেছি)।
...
Python/FastAPI ব্যাকএন্ড থেকে Firebase Admin SDK দিয়ে Realtime Database-এ ডেটা লেখা যায় এভাবে:

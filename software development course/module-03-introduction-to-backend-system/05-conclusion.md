...
```mermaid
flowchart TD
    A["এই কোর্সে আমরা কেন <br/> এই নির্দিষ্ট ক্রমে শিখবো"] --> B["Node.js কেন ভিত্তি <br/> (একই ভাষায় ব্রাউজার + সার্ভার)"]
    B --> C["Core Module কী <br/> (বিল্ট-ইন সুবিধা, যেমন http, fs)"]
...
- এটা কি Node.js-এর নিজস্ব (core module), নাকি বাইরে থেকে আনা (external package)?
...
**Module 4 — JavaScript With Node.js And Express.js** থেকে আমরা প্রথমবারের মতো **Express.js** framework ব্যবহার শুরু করবো, যেটা এই "কোন অনুরোধে কী করতে হবে" বোঝার কাজটা অনেক সহজ আর সুশৃঙ্খল করে দেয়। এবং তার আগে-পরে আমরা JavaScript-এর সেই মৌলিক ধারণাগুলোও ঝালিয়ে নেবো, যেগুলো ব্যাকএন্ড কোড লেখার সময় বারবার লাগবে — callback, let/var/const, আর কীভাবে একটা backend service নিজেই আরেকটা backend-এর client হতে পারে।

...
| 3 | [03-hashing-username-and-password.md](03-hashing-username-and-password.md) | Username ও Password হ্যাশ করা (crypto মডিউল) |
...
- Node-এর `crypto` মডিউল দিয়ে পাসওয়ার্ড নিরাপদে হ্যাশ করতে পারবে
- `jsonwebtoken` প্যাকেজ দিয়ে JWT তৈরি ও যাচাই করতে পারবে
- সম্পূর্ণ একটা Authentication ব্যবস্থা (রেজিস্ট্রেশন, লগইন, প্রোটেক্টেড রুট) নিজে হাতে বানাতে পারবে, ডেটাবেস ছাড়াই

পরবর্তী মডিউল: **Module 13 — Typescript With OOP**

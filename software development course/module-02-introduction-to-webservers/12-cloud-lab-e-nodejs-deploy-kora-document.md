# ১২. ক্লাউড ল্যাব এ Node.js ডেপলয় করা: ডকুমেন্ট
...
**Node.js ইনস্টল (Ubuntu/Debian ভিত্তিক VM):**
```bash
...
| `EADDRINUSE` এরর | একই পোর্টে আগে থেকে কিছু চলছে | `Ctrl+C` দিয়ে আগেরটা বন্ধ করো, বা অন্য পোর্ট ব্যবহার করো |
| SSH বন্ধ করলেই সার্ভারও বন্ধ হয়ে যায় | Node.js প্রসেসটা সেশনের সাথে যুক্ত | `pm2` বা `nohup` ব্যবহার করো (বিস্তারিত Module 33-এ) |
| `command not found: node` | Node.js ইনস্টল হয়নি বা PATH-এ নেই | ইনস্টলেশন কমান্ড আবার চালাও |

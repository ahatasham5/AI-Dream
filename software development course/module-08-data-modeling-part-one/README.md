...
| 8 | [08-array-json-and-higher-order-functions.md](08-array-json-and-higher-order-functions.md) | Array of JSON ও Higher Order Functions |
...
- dot/bracket notation আর mutable/immutable পদ্ধতিতে JSON object-এর ডেটা অ্যাক্সেস ও পরিবর্তন করতে পারবে
- `map`, `filter`, `reduce`, `find`-এর মতো higher-order function দিয়ে Array of Objects নিয়ে কার্যকরভাবে কাজ করতে পারবে
...
পরবর্তী মডিউল: **[Module 9 — JS Essentials For Backend Development](../module-09-js-essentials-for-backend-development/README.md)**

...
আগের লেসনে আমরা Subquery `WHERE`-এর ভেতরে ব্যবহার করেছি। কিন্তু Subquery-কে `FROM`-এর ভেতরেও বসানো যায় — তখন সেটা একটা "অস্থায়ী টেবিল"-এর মতো আচরণ করে, যাকে বলে **derived table** বা **nested query**। এটা অনেকটা JavaScript-এ একটা ফাংশনের রিটার্ন ভ্যালুকে সাথে সাথে আরেকটা ফাংশনে পাস করে দেয়ার (function composition) মতো — `outer(inner())`।

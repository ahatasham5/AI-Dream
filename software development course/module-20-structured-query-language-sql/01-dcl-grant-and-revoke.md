...
লক্ষ্য করার মতো একটা জিনিস — Node.js অ্যাপ্লিকেশন যখন ডাটাবেজে কানেক্ট করে (Module 15-তে যেমন `pg` বা `mysql2` দিয়ে দেখিয়েছিলাম), সেই কানেকশন স্ট্রিং-এর ইউজারনেমটাই আসলে একটা DCL role — তাই প্রোডাকশন অ্যাপকে কখনোই "root" বা "superuser" দিয়ে কানেক্ট করানো উচিত না, বরং ঠিক যতটুকু অনুমতি লাগে ততটুকু দেয়া role ব্যবহার করা উচিত।

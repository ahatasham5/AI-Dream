...
সমস্যা হলো, `.git/hooks/` ফোল্ডার সাধারণত গিটে commit হয় না, তাই এটা টিমের সবার সাথে সহজে শেয়ার করা যায় না। এই সমস্যার সমাধানে **Husky**-র মতো টুল ব্যবহার করা হয়, যেটা hook-কে প্রজেক্টের নিজের কোডের অংশ বানিয়ে দেয়:
...
git add .husky
git commit -m "pre-commit hook যোগ করা হলো Husky দিয়ে"
```

এখন থেকে যে কেউ এই রিপোজিটরি clone করে `npm install` করলে, hook স্বয়ংক্রিয়ভাবে সক্রিয় হয়ে যাবে। সাধারণ কিছু hook: `pre-commit` (কোড format/lint/test চেক), `commit-msg` (commit message-এর ফরম্যাট যাচাই, যেমন conventional commits), `pre-push` (push করার আগে পুরো টেস্ট স্যুট চালানো)।

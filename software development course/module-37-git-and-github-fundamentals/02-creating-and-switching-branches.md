...
ধরো `main`-এ একটা ফাইল `index.js` আছে যেখানে ৫০ লাইন কোড, আর `feature/wishlist-page`-এ সেই একই ফাইলে ৭০ লাইন (২০ লাইন নতুন যোগ হয়েছে)। যখন তুমি `main` থেকে `feature/wishlist-page`-এ সুইচ করো, VS Code-এ ফাইলটা খোলা থাকলে দেখবে সাথে সাথে ২০ লাইন নতুন কোড হাজির হয়ে গেছে — জাদুর মতো, কিন্তু আসলে এটা শুধু Git তোমার commit history থেকে সঠিক স্ন্যাপশটটা টেনে এনে ফাইলে বসিয়ে দিচ্ছে।

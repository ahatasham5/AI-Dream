...
```mermaid
flowchart TD
    Client[React Frontend] -->|HTTPS Request| Gateway[Express API Gateway]
    ...
    Routes --> Logs[Winston Logger - Module 32]
    Logs --> Monitor[PM2 / Datadog - Module 33]
```
...
5. প্রতিটা ধাপ Winston দিয়ে লগ হয়, আর PM2/Datadog সেই লগ আর মেট্রিক্স নজরদারি করে

...
উদাহরণ দিয়ে পার্থক্যটা স্পষ্ট করি। জাভাস্ক্রিপ্টে (Module 9-এ শেখা higher-order function দিয়ে) যদি তুমি অসম্পূর্ণ টাস্কগুলো খুঁজতে চাও:

```js
const pending = todos.filter(t => t.done === false);
```

এখানে তুমি নিজে বলে দিচ্ছো *কীভাবে* — `.filter()` মেথড দিয়ে, প্রতিটা এলিমেন্ট ঘুরে ঘুরে চেক করে। SQL-এ একই কাজ:
...
এখানে গঠনটা লক্ষ্য করো — `INSERT INTO <টেবিলের নাম> (<কলামগুলো>) VALUES (<মানগুলো>)`। এটা প্রায় জাভাস্ক্রিপ্টের অবজেক্ট লিটারেলের (Module 8-এ শেখা JSON structure) সাথে খুব মিল — শুধু `{ text: 'Learn PostgreSQL', done: false }` লেখার বদলে, কলামের নাম আর ভ্যালু আলাদা বন্ধনীতে লিখতে হয়।
...
একটা গুরুত্বপূর্ণ পার্থক্য মনে রাখা দরকার — SQL কমান্ডে প্রতিটা statement সাধারণত সেমিকোলন (`;`) দিয়ে শেষ হয়, ঠিক জাভাস্ক্রিপ্টের মতোই একটা লাইন শেষ করার নিয়ম, কিন্তু এখানে এটা প্রায় বাধ্যতামূলক, কারণ একই সাথে একাধিক statement পাঠানো সম্ভব:

...
- **Password** — এখানে `postgres` নামের সুপারইউজারের জন্য একটা পাসওয়ার্ড দিতে বলবে। এটা মনে রাখা **অত্যন্ত জরুরি** — এই পাসওয়ার্ডটাই পরে আমরা Node.js থেকে কানেক্ট করার সময় ব্যবহার করবো।
...
— তাহলে অভিনন্দন, তুমি সফলভাবে PostgreSQL সার্ভারের সাথে কানেক্ট হয়েছো! এই `postgres=#` প্রম্পটটা অনেকটা Node.js-এর REPL-এর মতো — এখানে তুমি সরাসরি SQL কমান্ড লিখতে পারো।
...
এখন আমাদের কম্পিউটারে একটা সত্যিকারের ডেটাবেজ ইঞ্জিন চলছে, শুনছে, অপেক্ষা করছে। পরের লেসনে আমরা এই ইঞ্জিনটাকে আমাদের Node.js/Express ব্যাকএন্ডের (Module 4-10) সাথে কানেক্ট করবো।

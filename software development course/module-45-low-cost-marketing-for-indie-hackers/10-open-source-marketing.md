...
JavaScript-এ বাংলা তারিখ ফরম্যাট করার একটা হালকা লাইব্রেরি।
InvoiceBari (invoicebari.com) প্রোজেক্টের অংশ হিসেবে তৈরি।

## ইনস্টলেশন
npm install bangla-date-format
```

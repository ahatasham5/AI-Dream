...
এই সমস্যা সমাধান করতেই এসেছে **Session** ধারণা — Cookie-তে শুধু একটা অর্থহীন, এলোমেলো ID রাখা হয়, আসল তথ্য জমা থাকে সার্ভারের নিজের মেমরিতে (বা ডেটাবেসে)। আমরা এটা প্রথমে নিজের হাতে (একটা সাধারণ JavaScript অবজেক্টে) বানিয়েছি, তারপর দেখেছি কীভাবে `express-session` লাইব্রেরি এই একই কাজ আরও নিরাপদ ও পরিণতভাবে করে।
...
flowchart TD
    ...
    D --> E["custom সমাধান: নিজস্ব sessionStore অবজেক্ট"]
    D --> F["পরিণত সমাধান: express-session লাইব্রেরি"]
```

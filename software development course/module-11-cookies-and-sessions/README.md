...
| 5 | [05-third-party-library-for-session-and-cookie.md](05-third-party-library-for-session-and-cookie.md) | Third Party Library দিয়ে Session ও Cookie (express-session, cookie-parser) |
...
- Express-এ Cookie সেট করতে, পড়তে, আর মেয়াদ নিয়ন্ত্রণ করতে পারবে
- Cookie ব্যবহার করে একটা সিম্পল লগইন সিস্টেম ও প্রোটেক্টেড রুট বানাতে পারবে
- নিজের হাতে (custom) এবং `express-session`/`cookie-parser` দিয়ে Session ম্যানেজ করতে পারবে
- Session ও Cookie-র পার্থক্য এবং Cookie-ভিত্তিক Authentication-এর সীমাবদ্ধতা বুঝবে

পরবর্তী মডিউল: **Module 12 — JWT (JSON Web Token)**

...
এই মডিউলে আমরা বেশ কয়েকটা ছোট ছোট কোড লিখেছি — callback-এর উদাহরণ, `let`/`var`/`const`-এর তুলনা, প্রথম Express সার্ভার, Path আর Query Parameter, আর দুটো সার্ভিসের একে অপরকে কল করার প্র্যাকটিস। এই প্রতিটা কোড আলাদা আলাদা ফাইলে, আলাদা সময়ে লেখা হয়েছে, আর টাইপ করতে করতে ছোটখাটো বানান ভুল বা অগোছালো ফোল্ডার-স্ট্রাকচার হয়ে যাওয়াটা খুবই স্বাভাবিক। এই মুহূর্তে একটা প্রশ্ন আসা উচিত — এই কোডগুলো যদি এমন এক জায়গায় গোছানো থাকতো, যেখান থেকে যেকোনো সময় আবার দেখা, ডাউনলোড করা, বা নিজের কোডের সাথে মিলিয়ে দেখা যায়, তাহলে কেমন হতো?

## কেন একটা companion কোড রিপোজিটরি দরকার

ধরো তুমি এই মডিউলের ৫ নম্বর লেসনের Express সার্ভারটা নিজে লিখেছো, কিন্তু কোথাও একটা টাইপো করার কারণে এটা চলছে না। এই মুহূর্তে সবচেয়ে দ্রুত সমাধান হলো — তোমার লেখা কোডটা মূল, সঠিক কোডের সাথে পাশাপাশি রেখে মিলিয়ে দেখা। এই কাজটা সহজ হয়ে যায় যদি প্রতিটা লেসনের সম্পূর্ণ, চালু-করা-যায় এমন কোড একটা নির্দিষ্ট জায়গায়, লেসন নম্বর অনুযায়ী সাজানো থাকে — যেমন একটা GitHub রিপোজিটরি, যার ভেতরে প্রতিটা মডিউলের জন্য একটা ফোল্ডার, আর প্রতিটা লেসনের জন্য তার ভেতরে একটা সাব-ফোল্ডার বা ফাইল।
...
git init
mkdir module-04-lesson-05-express-setup
```
...
এই মডিউলে আমরা JavaScript-এর কিছু মৌলিক ধারণা ঝালিয়ে নিয়ে, Express.js দিয়ে প্রথম রুট বানিয়ে, Postman/Thunder Client দিয়ে টেস্ট করে, Path আর Query Parameter শিখে, এমনকি দুটো backend-কে একে অপরের সাথে কথা বলিয়ে, আর FastAPI-র সাথে তুলনা করে একটা পূর্ণাঙ্গ ভিত্তি তৈরি করেছি। এই ভিত্তির উপর দাঁড়িয়ে, পরের মডিউলে আমরা এমন একটা প্রশ্নের উত্তর খুঁজবো যেটা এই পুরো মডিউল জুড়ে বারবার উঁকি দিয়েছে কিন্তু গভীরে যাইনি — Node.js আসলে কীভাবে একসাথে অনেক কাজ সামলায়, ভেতরে ভেতরে কী ঘটে যখন আমরা callback বা `async/await` লিখি। চলো যাই Module 5 — Async JS Inside Node.js-এ।

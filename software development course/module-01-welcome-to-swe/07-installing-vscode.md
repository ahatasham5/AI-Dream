...
| Extension | কাজ |
|---|---|
| **ESLint** | কোডে ভুল বা bad practice থাকলে সাথে সাথে সতর্ক করে |
| **Prettier** | কোড অটোমেটিক সুন্দরভাবে ফরম্যাট করে দেয় |
...
এই টার্মিনাল থেকেই আমরা `node`, `npm`, `git` — সব কমান্ড চালাবো। **অভ্যাস করো এখান থেকেই কাজ করার** — এতে মাউস আর কীবোর্ডের মধ্যে বারবার হাত বদলাতে হবে না, কাজের গতি অনেক বাড়বে।
...
flowchart LR
    ...
    Term --> Cmd["node -v টাইপ করো"]
    Cmd --> Check{ভার্সন দেখাচ্ছে?}
    Check -->|হ্যাঁ| Good[সেটআপ ঠিক আছে ✓]
    Check -->|না| Fix[Node.js ইনস্টলেশন আবার চেক করো]
```

যদি VS Code-এর Integrated Terminal থেকে `node -v` চালিয়ে ভার্সন দেখতে পাও, তার মানে তোমার IDE আর Runtime দুটোই ঠিকভাবে একসাথে কাজ করছে — পরের ধাপে যাওয়ার জন্য প্রস্তুত।

...
Backend-এ Node.js/Express (Module 4-5), অথেন্টিকেশন JWT দিয়ে (Module 12), ডাটাবেজে PostgreSQL, PDF জেনারেশনে `pdfkit` বা `puppeteer`, ইমেইল পাঠাতে Module 41-এ শেখা SendGrid ইন্টিগ্রেশন। পুরো সিস্টেমটা একজন মানুষের একাই মেইনটেইন করার মতো ছোট রাখাই লক্ষ্য — এটাই "ইনডি" স্টাইলের মূল কথা।
